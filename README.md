# Awesome Courses [![Awesome](https://img.shields.io/badge/Dev-Teocci-blue.svg)](https://github.com/teocci/)
...
- ![Lecture Videos][videos] - Lecture Videos
- ![Lecture Notes][notes] - Lecture Notes
- ![Lecture Assignments][assignments] - Assignments / Labs
- ![Lecture Readings][readings] - Readings

[videos]: https://img.shields.io/badge/Type-VD-red.svg
[notes]: https://img.shields.io/badge/Type-NT-yellow.svg
[assignments]: https://img.shields.io/badge/Type-AS-brightgreen.svg
[readings]: https://img.shields.io/badge/Type-RD-orange.svg
...
- [CS 61C](http://www-inst.eecs.berkeley.edu/~cs61c/sp15/) **Great Ideas in Computer Architecture (Machine Structures)** *UC Berkeley* ![Lecture Videos][videos]![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CS 107](https://courseware.stanford.edu/pg/courses/lectures/371747) **Computer Organization & Systems** *Stanford University* ![Lecture Videos][videos]
...
- [CS 140](http://web.stanford.edu/~ouster/cgi-bin/cs140-spring14/lectures.php) **Operating Systems** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 162](http://cs162.eecs.berkeley.edu/) **Operating Systems and Systems Programming** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CS 168](https://inst.eecs.berkeley.edu/~cs168/fa14/) **Introduction to the Internet: Architecture and Protocols** *UC Berkeley* ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [CS 179](http://courses.cms.caltech.edu/cs179/) **GPU Programming** *Caltech*  ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 186](https://sites.google.com/site/cs186spring2015/) **Introduction to Database Systems** *UC Berkeley* ![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [CS 241](https://courses.engr.illinois.edu/cs241/fa2014/index.html) **Systems Programming (Fall 2014)** *Univ of Illinois, Urbana-Champaign* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 425](https://courses.engr.illinois.edu/cs425/fa2014/index.html) **Distributed Systems** *Univ of Illinois, Urbana-Champaign* ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CS 452](http://www.cgl.uwaterloo.ca/~wmcowan/teaching/cs452/s12/) **Real-Time Programming** *University of Waterloo*  ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 2043](http://www.cs.cornell.edu/courses/CS2043/2014sp/) **Unix Tools & Scripting** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 3410](http://www.cs.cornell.edu/courses/cs3410/2016fa/) **Computer System Organization and Programming** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4410](http://www.cs.cornell.edu/courses/CS4410/2014fa/) **Operating Systems** *Cornell University* ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4414](http://rust-class.org/index.html) **Operating Systems** *University of Virginia* ![Lecture Videos][videos] ![Lecture Assignments][assignments]
...
- [CS 5412](http://www.cs.cornell.edu/Courses/CS5412/2014sp/) **Cloud Computing** *Cornell University* ![Lecture Notes][notes]
![Lecture Readings][readings]
...
- [CSCE 3613](http://comp.uark.edu/~wingning/csce3613/csce3613.html) **Operating Systems** *University of Arkansas (Fayetteville)* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]	- An introduction to operating systems including topics in system structures, process management, storage management, files, distributed systems, and case studies.
...
- [CSCI-UA.0202: Operating Systems (Undergrad)](http://www.cs.nyu.edu/~mwalfish/classes/15sp/index.html) **Operating Systems** *NYU* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings] 
...
- [CSCI 360](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci360/csci360_f14.php) **Computer Architecture 3** *CUNY Hunter College* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CSCI 493.66](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci493.66/csci493.66_spr12.php) **UNIX System Programming (formerly UNIX Tools)** *CUNY Hunter College* ![Lecture Assignments][assignments]
![Lecture Notes][notes]
...
- [CSCI 493.75](http://compsci.hunter.cuny.edu/~sweiss/course_materials/csci493.65/csci493.65_spr14.php) **Parallel Computing** *CUNY Hunter College* ![Lecture Assignments][assignments]
![Lecture Notes][notes]
...
- [Hack the Kernel](https://www.ops-class.org/) **Introduction to Operating Systems** *SUNY University at Buffalo, NY* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [ECE 459](http://patricklam.ca/p4p/) **Programming for Performance** *University of Waterloo* ![Lecture Notes][notes]
![Lecture Assignments][assignments]
...
- [MAE 6740](http://verifiablerobotics.com/courses/mae6740.html) **Hybrid Systems** *Cornell University* ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [PODC](http://dcg.ethz.ch/lectures/podc_allstars/) **Principles of Distributed Computing** *ETH-Zurich* ![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [SPAC](http://homes.cs.washington.edu/~djg/teachingMaterials/spac/) **Parallelism and Concurrency** *Univ of Washington* ![Lecture Readings][readings]
...
- [VU:Distributed Systems](http://www.distributed-systems.net/index.php?id=distributed-systems-principles-and-paradigms) **Distributed Systems: Principles and Paradigms (Fall 2012)** *Vrije Universiteit, Amsterdam* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.824](http://css.csail.mit.edu/6.824/2014/index.html) **Distributed Systems** *MIT* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.828](http://pdos.csail.mit.edu/6.828/2014/) **Operating Systems** *MIT* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [15-213](http://www.cs.cmu.edu/~213/) **Introduction to Computer Systems (ICS)** *Carnegie-Mellon University*  ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [15-418](http://15418.courses.cs.cmu.edu/spring2015/)**Parallel Computer Architecture and Programming** *Carnegie-Mellon University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [15-440](http://www.cs.cmu.edu/~dga/15-440/F12/index.html) **Distributed Systems** *Carnegie-Mellon University*  ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [15-721](http://15721.courses.cs.cmu.edu/spring2016/) **Database Systems** *Carnegie-Mellon University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [15-749](http://www.andrew.cmu.edu/course/15-749/) **Engineering Distributed Systems** *Carnegie-Mellon University* ![Lecture Readings][readings]	
...
- [18-447](http://www.ece.cmu.edu/~ece447/s14/doku.php?id=start) **Introduction to Computer Architecture** *CMU* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CIS 194](http://www.seas.upenn.edu/~cis194/) **Introduction to Haskell** *Penn Engineering* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CIS 198](http://cis198-2016s.github.io/) **Rust Programming** *UPenn* ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [Clojure](http://mooc.cs.helsinki.fi/clojure) **Functional Programming with Clojure** *University of Helsinki* ![Lecture Assignments][assignments]
...
- [CMSC 430](http://www.cs.umd.edu/class/spring2015/cmsc430/) **Introduction to Compilers** *Univ of Maryland* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [COS 326](http://www.cs.princeton.edu/~dpw/courses/cos326-12/info.php) **Functional Programming** *Princeton University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 143](https://web.stanford.edu/class/cs143/) **Compiler construction** *Stanford University* ![Lecture Notes][notes]![Lecture Assignments][assignments]
...
- [CS 164](https://sites.google.com/a/bodik.org/cs164/home) **Hack your language!** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 173](http://cs.brown.edu/courses/cs173/2014/) **Programming Languages** *Brown University* ![Lecture Videos][videos] ![Lecture Assignments][assignments]
...
- [CS 223](https://www.classes.cs.uchicago.edu/archive/2015/winter/22300-1/) **Purely Functional Data Structures In Elm** *University of Chicago* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 240h](http://www.scs.stanford.edu/14sp-cs240h/) **Functional Systems in Haskell** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 421](https://courses.engr.illinois.edu/cs421/fa2014/) **Programming Languages and Compilers** *Univ of Illinois, Urbana-Champaign* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 3110](http://www.cs.cornell.edu/Courses/cs3110/2014fa/course_info.php) **Data Structures and Functional Programming** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 4120](http://www.cs.cornell.edu/courses/CS4120/2013fa/) **Introduction to Compilers** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4400](https://pl.barzilay.org/) **Programming Languages** *Northeastern University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 4610](http://www.cs.virginia.edu/~weimer/4610/) **Programming Languages and Compilers** *University of Virginia* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 5114](http://www.cs.cornell.edu/courses/CS5114/2013sp/index.php) **Network Programming Languages** *Cornell University* ![Lecture Notes][notes]![Lecture Readings][readings]
	- An introduction to the specification and implementation of modern compilers. Topics covered include lexical scanning, parsing, type checking, code generation and translation, an introduction to optimization, and compile-time and run-time support for modern programming languages.  As part of the course, students build a working compiler for an object-oriented language.
...
- [CS 5142](http://www.cs.cornell.edu/courses/CS5142/2013fa/) **Scripting Languages** *Cornell University* ![Lecture Notes][notes]![Lecture Assignments][assignments]
...
- [CS 5470](http://matt.might.net/teaching/compilers/spring-2015/) **Compilers** *University of Utah* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 6118](http://www.cs.cornell.edu/courses/CS6118/2012fa/) **Types and Semantics** *Cornell University* ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CSC 253](http://pgbovine.net/cpython-internals.htm) **CPython internals: A ten-hour codewalk through the Python interpreter source code** *University of Rochester* ![Lecture Videos][videos]![Lecture Readings][readings]
...
- [CSE 341](http://courses.cs.washington.edu/courses/cse341/14sp/) **Programming Languages** *University of Washington* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CSE P 501](http://courses.cs.washington.edu/courses/csep501/09au/lectures/video.html) **Compiler Construction** *University of Washington* ![Lecture Videos][videos] ![Lecture Assignments][assignments]
...
- [DMFP](http://cs.wheaton.edu/~tvandrun/dmfp/) **Discrete Mathematics and Functional Programming** *Wheaton College* ![Lecture Videos][videos] ![Lecture Assignments][assignments]
...
- [PCPP](http://www.itu.dk/people/sestoft/itu/PCPP/E2015/) **Practical Concurrent and Parallel Programming** *IT University of Copenhagen* ![Lecture Notes][notes]![Lecture Assignments][assignments]![Lecture Readings][readings]
...
- [6.945](https://groups.csail.mit.edu/mac/users/gjs/6.945/index.html) **Adventures in Advanced Symbolic Programming** *MIT* ![Lecture Notes][notes]![Lecture Assignments][assignments]![Lecture Readings][readings]
...
- [CS 61B](http://cs61b.ug/sp16/) **Data Structures** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 97SI](http://web.stanford.edu/class/cs97si/) **Introduction to Competitive Programming** *Stanford University*  ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 224](http://people.seas.harvard.edu/~minilek/cs224/fall14/index.html) **Advanced Algorithms** *Harvard University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 261](http://theory.stanford.edu/~tim/w16/w16.html) **A Second Course in Algorithms** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 473/573](http://web.engr.illinois.edu/~jeffe/teaching/algorithms/) **Fundamental Algorithms** *Univ of Illinois, Urbana-Champaign* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 2150](https://github.com/aaronbloomfield/pdr) **Program & Data Representation** *University of Virginia* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 4820](http://www.cs.cornell.edu/courses/CS4820/2014sp/) **Introduction to Analysis of Algorithms** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CSCI 104](http://www-scf.usc.edu/~csci104/20142/lectures/) **Data Structures and Object Oriented Design** ![Lecture Assignments][assignments] ![Lecture Notes][notes] *University of Southern California (USC)*
...
- [CSCI 135](http://compsci.hunter.cuny.edu/~sweiss/courses/csci135.php) **Software Design and Analysis I** ![Lecture Assignments][assignments] ![Lecture Notes][notes]
*CUNY Hunter College*
...
- [CSCI 235](http://compsci.hunter.cuny.edu/~sweiss/courses/csci235.php) **Software Design and Analysis II** *CUNY Hunter College* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CSCI 335](http://compsci.hunter.cuny.edu/~sweiss/courses/csci335.php) **Software Design and Analysis III** ![Lecture Assignments][assignments] ![Lecture Notes][notes]
*CUNY Hunter College*
...
- [CSE 331](http://courses.cs.washington.edu/courses/cse331/15sp/) **Software Design and Implementation** *University of Washington* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CSE 373](http://www3.cs.stonybrook.edu/~skiena/373/) **Analysis of Algorithms** *Stony Brook University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [ECS 122A](http://web.cs.ucdavis.edu/~gusfield/cs122f10/) **Algorithm Design and Analysis** *UC Davis* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [ECS 222A](http://web.cs.ucdavis.edu/~gusfield/cs222w11/) **Graduate Level Algorithm Design and Analysis** *UC Davis* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.INT](http://courses.csail.mit.edu/iap/interview/index.php) **Hacking a Google Interview** *MIT* ![Lecture Readings][readings]
...
- [6.006](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/index.htm) **Introduction to Algorithms** *MIT* ![Lecture Videos][videos]![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [6.046J/18.410J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-046j-design-and-analysis-of-algorithms-spring-2015/index.htm) **Design and Analysis of Algorithms** *MIT* ![Lecture Videos][videos]![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [6.851](http://courses.csail.mit.edu/6.851/spring14/index.html) **Advanced Data Structures** *MIT* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.854/18.415J](http://courses.csail.mit.edu/6.854/current/) **Advanced Algorithms** *MIT* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.854J/18.415J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-854j-advanced-algorithms-fall-2005/index.htm) **Advanced Algorithms** *MIT* ![Lecture Notes][notes]![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [15-451/651](http://www.cs.cmu.edu/afs/cs/academic/class/15451-f10/www/) **Algorithms** *Carnegie Mellon University* ![Lecture Notes][notes]
...
- [16s-4102](http://www.cs.virginia.edu/~shelat/16s-4102/) **Algorithms** *University of Virginia* ![Lecture Videos][videos] ![Lecture Assignments][assignments] 
...
- [CIS 500](http://www.seas.upenn.edu/~cis500/cis500-f14/index.html) **Software Foundations** *University of Pennsylvania* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 103](http://web.stanford.edu/class/cs103/) **Mathematical Foundations of Computing** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 173](https://courses.engr.illinois.edu/cs173/fa2014/A-lecture/index.html) **Discrete Structures** *Univ of Illinois Urbana-Champaign* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 276](http://www.cs.berkeley.edu/~sanjamg/classes/cs276-fall14/) **Foundations of Cryptography** *UC Berkeley* ![Lecture Notes][notes]
...
- [CS 278](http://www.cs.berkeley.edu/~luca/cs278-08/) **Complexity Theory** *UC Berkeley* ![Lecture Notes][notes]
...
- [CS 374](https://courses.engr.illinois.edu/cs498374/fa2014/) **Algorithms & Models of Computation (Fall 2014)** *University of Illinois Urbana-Champaign* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 3110](http://www.cs.cornell.edu/courses/CS3110/2014fa/) **Data Structures and Functional Programming** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 3220](http://www.cs.cornell.edu/~bindel/class/cs3220-s12/) **Introduction to Scientific Computing** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4300](http://www.cs.cornell.edu/courses/CS4300/2013fa/) **Information Retrieval** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4810](http://www.cs.cornell.edu/~dsteurer/toc13/) **Introduction to Theory of Computing** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 6810](http://www.cs.cornell.edu/~dsteurer/complexity12/) **Theory of Computing** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CSCE 3193](http://www.csce.uark.edu/~sgauch/3193/S11/index.html) **Programming Paradigms** *University of Arkansas (Fayetteville)*	![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [6.045](https://stellar.mit.edu/S/course/6/sp15/6.045/index.html) **Great Ideas in Theoretical Computer Science** *MIT* ![Lecture Notes][notes] ![Lecture Videos][videos] ![Lecture Readings][readings]
...
- [CS 10](https://inst.eecs.berkeley.edu/~cs10/fa14/) **The Beauty and Joy of Computing** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 50](https://cs50.harvard.edu/) **Introduction to Computer Science** *Harvard University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 61A](http://cs61a.org/) **Structure and Interpretation of Computer Programs [Python]** *UC Berkeley*  ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 61AS](http://berkeley-cs61as.github.io/) **Structure & Interpretation of Computer Programs [Racket]** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 101](http://online.stanford.edu/course/computer-science-101-self-paced) **Computer Science 101** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 106A](https://see.stanford.edu/Course/CS106A) **Programming Methodology** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 106B](https://see.stanford.edu/Course/CS106B) **Programming Abstractions** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 107](https://see.stanford.edu/Course/CS107) **Programming Paradigms** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 109] (http://otfried.org/courses/cs109/index.html) **Programming Practice Using Scala** *KAIST* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 1109](http://www.cs.cornell.edu/courses/CS1109/2013su/) **Fundamental Programming Concepts** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 1110](http://www.cs.cornell.edu/courses/CS1110/2014fa/) **Introduction to Computing Using Python** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 1112](http://www.cs.cornell.edu/courses/CS1112/2014fa/) **Introduction to Computing Using Matlab** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 1115](http://www.cs.cornell.edu/courses/CS1115/2013fa/) **Introduction to Computational Science and Engineering Using Matlab Graphical User Interfaces** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
	- Programming and problem solving using MATLAB. Emphasizes the systematic development of algorithms and programs. Topics include iteration, functions, arrays and vectors, strings, recursion, algorithms, object-oriented programming, and MATLAB graphics. Assignments are designed to build an appreciation for complexity, dimension, fuzzy data, inexact arithmetic, randomness, simulation, and the role of approximation. NO programming experience is necessary; some knowledge of Calculus is required.
...
- [CS 1130](http://www.cs.cornell.edu/courses/CS1130/2014sp/) **Transition to OO Programming** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 1133](http://www.cs.cornell.edu/courses/CS1133/2013fa/) **Transition to Python** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 1410-2](http://www.eng.utah.edu/~cs1410-20/) and [CS2420-20](http://www.eng.utah.edu/~cs2420-20/) **Computer Science I and II for Hackers** *University of Utah* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 2110](http://www.cs.cornell.edu/courses/CS2110/2014fa/index.html) **Object-Oriented Programming and Data Structures** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4302](http://courses2.cit.cornell.edu/info4302_2012fa/) **Web Information Systems** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CSCE 2004](http://www.csce.uark.edu/~sgauch/2004/S14/index.html) **Programming Foundations I** *University of Arkansas (Fayetteville)* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS-for-all](http://www.cs.hmc.edu/csforall/) **CS for All**  *Harvey Mudd College* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [6.001](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-001-structure-and-interpretation-of-computer-programs-spring-2005/index.htm) **Structure and Interpretation of Computer Programs** *MIT* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [COMS 4771](http://www.cs.columbia.edu/~jebara/4771/index.html) **Machine Learning** *Columbia University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 109](http://cs109.github.io/2015/) **Data Science** *Harvard University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 156](https://work.caltech.edu/telecourse.html) **Learning from Data** *Caltech* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 224d](http://cs224d.stanford.edu/) **Deep Learning for Natural Language Processing** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 229r](http://people.seas.harvard.edu/~minilek/cs229r/fall15/index.html) **Algorithms for Big Data** *Harvard University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 231n](http://cs231n.stanford.edu/) **Convolutional Neural Networks for Visual Recognition** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Videos][videos]
...
- [CS 287](http://www.cs.berkeley.edu/~pabbeel/cs287-fa13/) **Advanced Robotics** *UC Berkeley* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 395T](http://www.nr.com/CS395T/) **Statistical and Discrete Methods for Scientific Computing** *University of Texas* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [CS 4780](http://www.cs.cornell.edu/courses/CS4780/2014fa/) **Machine Learning** *Cornell University* ![Lecture Notes][notes]![Lecture Readings][readings]
	- This course will introduce you to technologies for building data-centric information systems on the World Wide Web, show the practical applications of such systems, and discuss their design and their social and policy context by examining cross-cutting issues such as citizen science, data journalism and open government. Course work involves lectures and readings as well as weekly homework assignments, and a semester-long project in which the students demonstrate their expertise in building data-centric Web information systems.
	- [Syllabus](http://www.cs.cornell.edu/courses/CS4780/2014fa/)
	- [Lectures](http://www.cs.cornell.edu/courses/CS4780/2014fa/)
- [CS 4786](http://www.cs.cornell.edu/courses/CS4786/2015sp/index.htm) **Machine Learning for Data Science** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CVX 101](https://class.stanford.edu/courses/Engineering/CVX101/Winter2014/info) **Convex Optimization** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
 ![Lecture Readings][readings]
...
- [DS-GA 1008](http://cilvr.cs.nyu.edu/doku.php?id=deeplearning2015:schedule) **Deep Learning** *New York University* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [EECS E6893 & EECS E6895](http://www.ee.columbia.edu/~cylin/course/bigdata/) **Big Data Analytics & Advanced Big Data Analytics** *Columbia University* ![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [EECS E6894](http://llcao.net/cu-deeplearning15/index.html) **Deep Learning for Computer Vision and Natural Language Processing** *Columbia University* ![Lecture Notes][notes] ![Lecture Assignments][assignments]  ![Lecture Readings][readings]
...
- [EE103](http://stanford.edu/class/ee103/) **Introduction to Matrix Methods** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [Info 290](http://www.ischool.berkeley.edu/courses/i290-abdt) **Analyzing Big Data with Twitter** *UC Berkeley school of information* ![Lecture Videos][videos]
...
- [Machine Learning: 2014-2015](https://www.cs.ox.ac.uk/people/nando.defreitas/machinelearning/) *University of Oxford* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [StatLearning](https://lagunita.stanford.edu/courses/HumanitiesandScience/StatLearning/Winter2015/about) **Intro to Statistical Learning** *Stanford University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings] ![Lecture Videos][videos]
...
- [10-601](http://www.cs.cmu.edu/~ninamf/courses/601sp15/) **Machine Learning** *Carnegie Mellon University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings] ![Lecture Videos][videos]
...
- [10-708](http://www.cs.cmu.edu/~epxing/Class/10708-14/index.html) **Probabilistic Graphical Models** *Carnegie Mellon University* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [11-785](http://deeplearning.cs.cmu.edu/) **Deep Learning** *Carnegie Mellon University* ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
### Security
- [CIS 4930 / CIS 5930](http://www.cs.fsu.edu/~redwood/OffensiveComputerSecurity/) **Offensive Computer Security** *Florida State University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 155](https://courseware.stanford.edu/pg/courses/349991/cs155-spring-2013) **Computer and Network Security** *Stanford* ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 161](http://www-inst.eecs.berkeley.edu/~cs161/sp15/) **Computer Security** *UC Berkeley* ![Lecture Notes][notes]
...
- [CS 259](https://courseware.stanford.edu/pg/courses/331628/cs259-winter-2013) **Security Modeling and Analysis** *Stanford* ![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CS 261](http://www.icir.org/vern/cs261n-Sp14/) **Internet/Network Security** *UC Berkeley* ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 5430](http://www.cs.cornell.edu/courses/CS5430/2013sp/) **System Security** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CSCI 4968](https://github.com/RPISEC/MBE) **Modern Binary Exploitation** *Rensselaer Polytechnic Institute* ![Lecture Notes][notes]![Lecture Assignments][assignments]
...
- [CSCI 4976](https://github.com/RPISEC/Malware) **Malware Analysis** *Rensselaer Polytechnic Institute* ![Lecture Notes][notes]![Lecture Assignments][assignments]
	- This repository contains the materials as developed and used by [RPISEC](http://rpis.ec) to
...
- [EECS 588](https://www.eecs.umich.edu/courses/eecs588/) **Computer & Network Security** *University of Michigan* ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [6.857](http://courses.csail.mit.edu/6.857/2015/) **Computer and Network Security** *MIT* ![Lecture Notes][notes]
...
- [6.858](http://css.csail.mit.edu/6.858/2014/) **Computer Systems Security** *MIT* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [18-636](https://courseware.stanford.edu/pg/courses/334553/18636-spring-2013) **Browser Security** *Stanford* ![Lecture Videos][videos] ![Lecture Notes][notes]
...
- [CS 188](http://ai.berkeley.edu/home.html) **Introduction to Artificial Intelligence** *UC Berkeley* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 4700](http://www.cs.cornell.edu/courses/CS4700/2014fa/) **Foundations of Artificial Intelligence** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 6700](http://www.cs.cornell.edu/courses/CS6700/2013sp/) **Advanced Artificial Intelligence** *Cornell University* ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [6.868J](http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-868j-the-society-of-mind-fall-2011/index.htm) **The Society of Mind** *MIT* ![Lecture Notes][notes] ![Lecture Assignments][assignments]  ![Lecture Readings][readings]
...
-------
### Computer Graphics
- [CAP 5415](http://crcv.ucf.edu/courses/CAP5415/) **Computer Vision** *University of Central Florida* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [CIS 581](https://alliance.seas.upenn.edu/~cis581/wiki/index.php?title=CIS_581:_Computer_Vision_%26_Computational_Photography) **Computer Vision and Computational Photography** *University of Pennsylvania* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CMU 462](http://15462.courses.cs.cmu.edu/fall2015) **Computer Graphics** *Carnegie Mellon University* ![Lecture Notes][notes] ![Lecture Assignments][assignments] ![Lecture Readings][readings]
...
- [CS 378](https://github.com/ut-cs378-vision-2014fall/course-info) **3D Reconstruction with Computer Vision** *UTexas* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 4620](http://www.cs.cornell.edu/Courses/CS4620/2014fa/index.shtml#) **Introduction to Computer Graphics** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 4670](http://www.cs.cornell.edu/courses/CS4670/2015sp/) **Introduction to Computer Vision** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
	- This course will provide an introduction to computer vision, with topics including image formation, feature detection, motion estimation, image mosaics, 3D shape reconstruction, and object and face detection and recognition. Applications of these techniques include building 3D maps, creating virtual characters, organizing photo and video databases, human computer interaction, video surveillance, automatic vehicle navigation, and mobile computer vision. This is a project-based course, in which you will implement several computer vision algorithms throughout the semester.
...
- [CS 6670](https://canvas.instructure.com/courses/904706) **Computer Vision** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CSCI-GA.2270-001](https://mrl.nyu.edu/~perlin/courses/fall2015/) **Graduate Computer Graphics** *New York University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
-------
### Misc
- [AM 207](http://am207.github.io/2016/index.html) **Monte Carlo Methods and Stochastic Optimization** *Harvard University* ![Lecture Videos][videos] ![Lecture Notes][notes] ![Lecture Assignments][assignments]
...
- [CS 75](http://ocw.tufts.edu/Course/75)  **Introduction to Game Development** *Tufts University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 100](https://github.com/mikeizbicki/ucr-cs100) **Open Source Software Construction** *UC Riverside* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 108](http://web.stanford.edu/class/cs108/) **Object Oriented System Design** *Stanford* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 168](https://inst.eecs.berkeley.edu/~cs168/fa15/) **Computer Networks** *UC Berkeley*![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [CS 193a](http://web.stanford.edu/class/cs193a/lectures.shtml) **Android App Development, Spring 2016** *Stanford University* ![Lecture Videos][videos]![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 193p](https://itunes.apple.com/us/course/developing-ios-7-apps-for/id733644550) **Developing Applications for iOS** *Stanford University* ![Lecture Videos][videos]![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 223A](http://see.stanford.edu/see/courseinfo.aspx?coll=86cc8662-f6e4-43c3-a1be-b30d1d179743) **Introduction to Robotics** *Stanford University* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 262a](http://www.cs.berkeley.edu/~brewer/cs262/) **Advanced Topics in Computer Systems** *UC Berkeley* ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [CS 294](http://inst.eecs.berkeley.edu/~cs294-101/sp15/) **Cutting-edge Web Technologies** *Berkeley* ![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
...
- [CS 411](http://video.bilkent.edu.tr/course_videos.php?courseid=10) **Software Architecture Design** *Bilkent University* ![Lecture Videos][videos]
...
- [CS 3152](http://www.cs.cornell.edu/courses/CS3152/2014sp/) **Introduction to Computer Game Development** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4152](http://www.cs.cornell.edu/courses/CS4152/2014sp/) **Advanced Topics in Computer Game Development** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4154](http://www.cs.cornell.edu/courses/CS4154/2014fa/) **Analytics-driven Game Design** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 4812](https://courses.cit.cornell.edu/physics4481-7681_2014sp/) **Quantum Information Processing** *Cornell University* ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 4860](http://www.cs.cornell.edu/courses/CS4860/2012fa/) **Applied Logic** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 5150](http://www.cs.cornell.edu/courses/CS5150/2014fa/overview.html) **Software Engineering** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 5220](http://www.cs.cornell.edu/~bindel/class/cs5220-f11/) **Applications of Parallel Computers** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 5540](https://sites.google.com/site/cs5540sp2013/) **Computational Techniques for Analyzing Clinical Data** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]![Lecture Readings][readings]
...
- [CS 5724](http://courses2.cit.cornell.edu/cs5724/) **Evolutionary Computation** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 6452](http://www.cs.cornell.edu/courses/CS6452/2012sp/index.php) **Evolutionary Computation** *Cornell University* ![Lecture Notes][notes]
...
- [CS 6630](http://www.cs.cornell.edu/courses/CS6630/2012sp/about.stm) **Realistic Image Synthesis** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CS 6640](http://www.cs.cornell.edu/courses/CS6640/2012fa/index.shtml#) **Computational Photography** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [CS 6650](http://www.cs.cornell.edu/courses/CS6650/2013fa/) **Computational Motion** *Cornell University* ![Lecture Readings][readings]
...
- [CS 6840](http://www.cs.cornell.edu/courses/CS6840/2014sp/) **Algorithmic Game Theory** *Cornell University* ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [CSE 154](http://courses.cs.washington.edu/courses/cse154/14au/) **Web Programming** *University of Washington* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [ESM 296-4F](http://ucsb-bren.github.io/esm296-4f/) **GIS & Spatial Analysis** *UC Santa Barbara* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [ICS 314](http://philipmjohnson.github.io/ics314f13/) **Software Engineering** *University of Hawaii*  ![Lecture Assignments][assignments] ![Lecture Notes][notes] ![Lecture Readings][readings]
...
- [IGME 582](http://hfoss-fossrit.rhcloud.com) **Humanitarian Free & Open Source Software Development** *Rochester Institute of Technology* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [I485 / H400](http://www.informatics.indiana.edu/rocha/i-bic/) **Biologically Inspired Computation** *Indiana University* ![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [Open Sourced Elective: Database and Rails](http://www.schneems.com/ut-rails/) **Intro to Ruby on Rails** *University of Texas* ![Lecture Videos][videos]![Lecture Assignments][assignments] ![Lecture Notes][notes]
...
- [SCICOMP](http://mlecture.uni-bremen.de/ml/index.php?option=com_content&view=article&id=233) **An Introduction to Efficient Scientific Computation** *Universität Bremen* ![Lecture Videos][videos]
...
- [14-740](http://ini740.com/F15/) **Fundamentals of Computer Networks** *CMU* ![Lecture Videos][videos] ![Lecture Assignments][assignments] ![Lecture Readings][readings] ![Lecture Notes][notes]
